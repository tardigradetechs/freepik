...
<div class="modal">
    <a href="admin_upin.php"><span class="close" title="Close Modal">&times;</span></a>
  
  <form class="modal-content container" action="admin_upin.php" method="post"  enctype="multipart/form-data">
    <div class="container">      
