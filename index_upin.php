...
<div class="licon">      
      <input type="button" value="Edit" onclick="location.href='index_edit.php'" class="cancelbtn back-siin" >
      <input type="button" value="Confirm" onclick="location.href='index_re.php'" class="cancelbtn next-siin" >
    </div>
